...
import com.charan.myapplication.model.User;
    ...
    public void RegisterInServer(User userModel) {
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    if (response.body() != null) {
                        ...
                        SharedPreferences preferences = Objects.requireNonNull(getActivity()).getSharedPreferences("myPrefs", Context.MODE_PRIVATE);
                    ...
                    Log.d("fail", "fail");
                    Toast toast = Toast.makeText(getActivity(),"error in onresponse", Toast.LENGTH_SHORT);
            ...
            public void onFailure(Call<User> call, Throwable t) {
                ...
                Log.d("fail", "fail");
                Toast toast = Toast.makeText(getActivity(),"error in onfailure", Toast.LENGTH_SHORT);
